...
describe('VacancyEdit API states', () => {
  ...
  it('rejects missing, nonnumeric and out-of-range IDs without HTTP requests', () => {
    const fixture = TestBed.createComponent(VacancyEdit);
  ...
  it('handles a null GET response without fabricating vacancy data', () => {
    ...
    expect(fixture.componentInstance.loadedVacancy).toBeNull();
  });
  ...
  it('does not save or close when no vacancy has loaded', () => {
    const fixture = TestBed.createComponent(VacancyEdit);
    fixture.detectChanges();
    fixture.componentInstance.saveChanges();
    fixture.componentInstance.confirmCloseVacancy();
    expect(fixture.componentInstance.showSaveMessage).toBe(false);
    http.expectNone(() => true);
  });
